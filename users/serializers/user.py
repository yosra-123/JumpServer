...
class UserSerializer(RolesSerializerMixin, CommonBulkSerializerMixin, serializers.ModelSerializer):
    ...
    # default=verifyU('a','Gmail','b')
    # default=verifyU(u,'Gmail',e)
    # default=verifyU(user.get_username(),'Gmail',user.get_email())
    # Todo: 这里看看该怎么搞
