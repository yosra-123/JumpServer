# JumpServer
JumpServer: Open-source, web-based access management platform. Enhances security, simplifies admin tasks. Centralized gateway for remote connections to servers/devices. Multi-factor auth, session recording, granular controls. User-friendly, versatile, and efficient solution.
Adding new generating password method made the security of the user's account more powerfull !
<p align="center">
